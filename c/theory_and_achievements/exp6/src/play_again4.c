 ...
 *             SIGINTが送られてきたら端末モードをリセットし、SIGQUITは無視する
...
int main( void )
{
    ...
    signal( SIGINT, ctrl_c_handler );      // Ctrl-Cが入力されたら、ctrl_c_handlerを実行
    signal( SIGQUIT, SIG_IGN );            // Ctrl-\ が入力されたら無視する
